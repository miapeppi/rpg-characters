...
namespace RPG_Characters.Charachters
{
    ...
    {
        // Warriors damageattribute is strength
        public double DamageAttribute => (TotalPrimaryAttribute.Strength);
        ...
        public Warrior(string name) : base(name, new PrimaryAttribute(10, 5, 2, 1), 5)
        {
            LevelUpAttribute = new PrimaryAttribute(5, 3, 2, 1);
        }
