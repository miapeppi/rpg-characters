...
namespace RPG_Characters.Charachters
{
    ...
    {
        // Mages damageattribute is intelligence
        public double DamageAttribute => (TotalPrimaryAttribute.Intelligence);
        ...
        public Mage(string name): base(name, new PrimaryAttribute(5, 1, 1, 8), 8)
        {
            LevelUpAttribute = new PrimaryAttribute(3, 1, 1, 5);
        }
